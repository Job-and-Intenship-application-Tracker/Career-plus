          ...
          <div className="flex items-center space-x-3 cursor-pointer">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="bg-emerald-100 text-emerald-800 text-[10px] font-black px-2 py-0.5 rounded-full border border-emerald-200 hidden lg:inline-flex items-center" title="Active Storage Engine: SQLite Database">
                  🗄️ Storage: SQLite DB
                </span>
              </div>
