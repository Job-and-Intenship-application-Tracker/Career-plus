...
import { Briefcase, Plus, User, LogOut, Sparkles, ChevronDown } from 'lucide-react';

export default function Navbar({ currentUser, onOpenAddModal, onOpenProfileModal, onLogout }) {
