            ...
            >
              ...
              <div className="pt-3 border-t border-amber-200/80 flex items-center justify-between gap-3">
                <button
                  ...
                  className="w-full py-2.5 px-4 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs font-black flex items-center justify-center space-x-2 transition-colors shadow-md shadow-amber-600/20 cursor-pointer"
                >
