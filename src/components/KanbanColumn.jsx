...
export default function KanbanColumn({ title, statusKey, count, jobs = [], colorTheme, onAddCard, onSelectJob, isFocused = false, isDimmed = false }) {
  ...
  const ITEMS_PER_PAGE = 2; // Clean 2 cards per page per column for 100% uniform UI layout
  ...
  return (
    <div 
      className={`flex flex-col justify-between rounded-3xl border h-full min-h-[860px] p-4 transition-all duration-300 relative ${
        isFocused 
    ...
    >
      ...
      <div>
        ...
        <div className="space-y-3 custom-scrollbar overflow-y-auto pr-0.5 min-h-[790px] flex flex-col justify-start">
